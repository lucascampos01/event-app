...
export function Home() {
  ...
  function handleParticipantAdd() {
    if (participants.includes(participantName)) {
      return Alert.alert(
        "Participante existe",
        `${name} já está cadastrado na lista de participantes deste evento.`
      );
    }
    if (participantName === "") {
      return Alert.alert(
        "Erro ao adicionar participante",
        "Por favor, digite um nome válido e tente novamente."
      );
    }
